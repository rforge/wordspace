...
\begin{frame}[c]
  ...
  \centering
  \only<beamer:0| handout:0>{\includegraphics[width=10cm]{img/SE_bardiwac_conc}}%
  \only<beamer:1| handout:1>{\includegraphics[width=10cm]{img/SE_bardiwac_sketch}}%
\end{frame}
...
\begin{frame}
  ...
  \item Different types of contexts \citep{Evert:08}
    ...
    \item \hh{syntactic context} (specific syntagmatic relation)
